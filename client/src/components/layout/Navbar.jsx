...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm h-16 flex items-center">
      <div className="max-w-7xl mx-auto w-full px-4 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5 flex-shrink-0">
          ...
          <button onClick={() => navigate('/search')} className="md:hidden p-2 text-gray-600 bg-gray-50 rounded-full">
